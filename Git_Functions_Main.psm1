...
function ct { 
    ...
    Write-Host ("Help: cgh or cghelp or cghelpa; Time git: ct ""any git command here""") 
}
...
function cgmon {Get-Counter "\Process(powershell*)\% Processor Time" -SampleInterval 1 -MaxSamples 9999}
